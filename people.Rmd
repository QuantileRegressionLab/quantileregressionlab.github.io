...
### Director
<center>
```{r, echo=FALSE, out.extra='class="myimg"', fig.cap= "[Lea Petrella](https://quantileregressionlab.github.io/petrella.html)"}
...
```{r, echo=FALSE, out.extra='class="myimg"', fig.cap= "[Nicola Salvati](https://quantileregressionlab.github.io/salvati.html)"}
